    ...
    return (
        <div className="max-w-6xl mx-auto py-16">
            ...
            <div className="max-w-3xl mx-auto">
                <h2 className="text-3xl font-medium text-center">New User</h2>
                <p className="font-medium text-gray-400 text-center">Use the below form to create a new account</p>
                <form className="mt-8" onSubmit={handleNewUser}>
                    <div className="mb-4">
                        <label htmlFor="name" className="block mb-1 ps-1 font-bold text-gray-500 text-lg">Name</label>
                        <input type="text" name="name" id="name" placeholder="Name" className="border w-full ps-3 py-2 rounded-lg outline-0 shadow-md" />
                    </div>
                    <div className="mb-8">
                        <label htmlFor="email" className="block mb-1 ps-1 font-bold text-gray-500 text-lg">Email</label>
                        <input type="email" name="email" id="email" placeholder="Email" className="border w-full ps-3 py-2 rounded-lg outline-0 shadow-md" />
                    </div>
                    ...
                    <button type="submit" className="mt-8 text-lg font-bold text-center w-full btn btn-accent text-gray-800">Save</button>
                </form>
            </div>
        </div>
    );
